...
if __name__ == "__main__":
    ...
    new_df_DSC.to_csv('./output_active/new_df_DSC.csv', index=False, encoding='utf-8-sig')
    ...
    new_df_MCI.to_csv('./output_active/new_df_MCI.csv', index=False, encoding='utf-8-sig')
    ...
    new_df_AD.to_csv('./output_active/new_df_AD.csv', index=False, encoding='utf-8-sig')
    ...
    plot_brain_comparison(
        ...
        view='medial',
        path="./output_active/output_medial.png"
    )
    ...
    plot_brain_comparison(
        ...
        titles=['NC vs SCD', 'NC vs MCI', 'Nor vs AD'],
        view='dorsal',
        path="./output_active/output_dorsal.png"
    )
    ...
    plot_brain_comparison(
        ...
        titles=['NC vs SCD', 'NC vs MCI', 'Nor vs AD'],
        view='posterior',
        path="./output_active/output_posterior.png"
    )
    ...
    plot_brain_comparison(
        ...
        titles=['NC vs SCD', 'NC vs MCI', 'Nor vs AD'],
        view='ventral',
        path="./output_active/output_ventral.png"
    )
